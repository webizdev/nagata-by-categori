    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-start">
            ...
            <div class="space-y-8 pt-2">
                ...
                {{-- CTA: Contact --}}
                @php
                    $waProduct = preg_replace('/[^0-9]/', '', $webSettings['whatsapp'] ?? '628123456789');
                    if (str_starts_with($waProduct, '0')) {
                        $waProduct = '62' . substr($waProduct, 1);
                    } elseif (!empty($waProduct) && !str_starts_with($waProduct, '62')) {
                        $waProduct = '62' . $waProduct;
                    }
                @endphp
                <div class="pt-2 flex flex-col sm:flex-row gap-4">
                    <a href="https://wa.me/{{ $waProduct }}?text=Halo%20Nagata%20Daytona,%20saya%20tertarik%20dengan%20produk%20{{ $product->name }}" target="_blank"
